SuccList = {'A': [['B', 3], ['C', 2]], 'B': [['D', 2], ['E', 3]], 'C': [['F', 2], [
    'G', 4]], 'D': [['H', 1], ['I', 99]], 'F': [['J', 1]], 'G': [['K', 99], ['L', 3]]}
Start = 'A'
...
# goalPositions = [(3, 3), (1, 1), (1, 2), (1, 3), (2, 1),
#                  (2, 2), (2, 3), (3, 1), (3, 2), (3, 3)]

# #These colors are in sequence for 1 to 8
# numColors = ['black', 'red', 'skyblue', 'yellow',
#              'green', 'orange', 'pink', 'magenta', 'violet']
...
#       tempBoardPositions[curBlank[0]][curBlank[1]
#                                       ] = tempBoardPositions[move[0]][move[1]]
...
#          break
#       move = blankNewPos[0]
#       print("Recommended move is {} because of h val = {}".format(
#           move, blankNewPos[1]))
